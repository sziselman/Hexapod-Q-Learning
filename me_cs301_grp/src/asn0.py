...
class HexapodControl(RobotControl):
    def __init__(self):
        ...
        while not rospy.is_shutdown(): 
            ...
            # print("front sensor reading: ", self.getSensorValue('front'))
            # print("left sensor reading: ", self.getSensorValue('left'))
            # print("right sensor reading: ", self.getSensorValue('right'))
            ...
            if (self.getSensorValue('front') > 0):
                ang += gain*0.1
                self.setMotorTargetJointPosition('leg1_j3', ang)
            if (self.getSensorValue('left') > 0):
                ang += gain*0.1
                self.setMotorTargetJointPosition('leg5_j3', ang)

            print("sensor value: ", self.getSensorValue('front'))
            print("joint angle: ", ang)
